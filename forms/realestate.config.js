...
var FORM={
  ...
  /* ⛔ **이 서식은 「가족관계등록 신고서」가 아니다.** 2026.08.29 담당자 확정본의
     ...
     ⛔ 담당자가 준 세 줄이 전부다. **자금조달계획서·법인 관련 서류·토지거래허가 서류 같은
        개별 예외서류를 여기에 보태지 마라** — 거래 형태마다 달라지고, 무엇이 필요한지는
        창구가 정한다. 세 번째 줄이 그 모두를 덮는다.
     ⛔ **허브 카탈로그(`index.html`)의 같은 항목과 글자까지 같아야 한다.** */
  ready:[
    { t:"부동산 거래계약서 사본", g:"document", req:true },
    { t:"신고인 신분증", s:"접수할 때 창구에서 확인합니다", g:"idcard", req:true },
    { t:"거래 유형에 따른 관련 서류", s:"거래 내용에 따라 추가 서류가 필요할 수 있습니다", g:"cert" }
  ],
  ...
  STEPS:[
    ...
    {n:7, short:"소재지·면적", title:"⑥⑦ 어디에 있는 부동산인가요?",
      ...
      body:function(A){ var h='';
        ...
        /* ⚠️ 2026.08.29 실사용 QA — 위 경고 상자와 이 칸의 도움말이 **같은 말을 두 번** 하고
           있었다. 경고는 상자 한 곳에서만 하고, 도움말은 상자가 말하지 않는 것
           (①② 주소란과 다르다는 점)만 남긴다. ⛔ 업무 내용은 그대로다. */
        h+=A.inputHtml({k:"p_addr", label:"⑥ 소재지 (지번주소)", req:true,
          ph:"경기도 군포시 산본동 000-0 101동 1001호",
          help:"①② 주소란(주민등록 주소)은 도로명으로 적어도 되지만, 이 칸은 다릅니다."});
  ...
  applySample:function(state, kind){
    ...
    Object.assign(state,{
      step:2,
      s_name:"조성호", s_jumin:"6001011000000",
      ...
      b_name:"장민서", b_jumin:"8503152000000",
      b_addr:"경기도 안양시 동안구 시민대로 000",
      b_natl:"대한민국", b_mobile:"01098765432",
      hasAgent:true, a_name:"정광호", a_jumin:"7205051000000",
      ...
      nxb:"1",
      xb1_name:"윤지호", xb1_jumin:"8709181000000",
