...
var FORM={
  ...
  /* 안내 기둥의 준비물.
     ⛔ 지어내지 않았다 — 사망진단서(시체검안서)는 이 서식이 요구하는 첨부서류이고,
        종전 화면에도 이미 같은 문장이 있었다. 나머지 조건부 서류는 창구가 안내한다. */
  ready:[
    { t:"신고인 신분증", s:"접수할 때 창구에서 확인합니다", g:"idcard", req:true },
    { t:"사망진단서 또는 시체검안서", s:"의사가 작성한 것", g:"cert", req:true },
    ...
    {n:8, short:"완료", title:"작성 내용 확인", q:"입력한 내용을 확인하세요.", kind:"summary",
      body:function(){
        return buildSummary()
          ...
          +'<b>사망진단서(또는 시체검안서)</b>를 함께 내셔야 하며, 그 밖의 첨부서류는 담당 직원이 안내합니다.</div>';
      }}
  ],
