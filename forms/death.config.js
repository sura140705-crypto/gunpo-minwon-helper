...
var FORM={
  ...
  applySample:function(state, kind){
    Object.assign(state,{
      step:2,
      d_surKor:"조", d_givenKor:"판석", d_surHan:"趙", d_givenHan:"判石", d_sex:"남",
      d_jumin:"4001011000000", d_regBase:"경기도 군포시 속달동 000-0",
      d_addr:"경기도 군포시 속달동 000-0",
      d_headName:"조판석", d_headRel:"본인",
      ...
      etc:"",
      r_name:"조현우", r_jumin:"7203151000000", r_qual:"동거친족", r_rel:"자(子)",
      r_addr:"경기도 군포시 속달동 000-0", r_phone:"01012345678",
      r_email:"hyunwoo@example.com"
    });
    if(kind==="home"){
      state.d_place="주택"; state.d_placeDetail="경기도 군포시 속달동 000-0";
      state.d_marital="배우자 있음";
      state.r_name="정영자"; state.r_jumin="4503152000000"; state.r_qual="동거친족"; state.r_rel="배우자";
