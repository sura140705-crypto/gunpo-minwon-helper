...
var FORM={
  ...
  applySample:function(state, kind){
    Object.assign(state,{
      step:2,
      child_surKor:"정", child_givenKor:"하늘", child_surHan:"鄭", child_givenHan:"하늘",
      ...
      child_headName:"정우진", child_headRel:"자녀(녀)",
      f_name:"정우진", f_nameHan:"鄭宇鎭", f_bon:"東萊", f_jumin:"8803151000000",
      f_regBase:"경기도 군포시 당동 000-0", f_edu:"대학(교)",
      m_name:"윤서연", m_nameHan:"尹書娟", m_bon:"坡平", m_jumin:"9007222000000",
      m_regBase:"경기도 군포시 부곡동 000-0", m_edu:"대학(교)",
      sonbon_consent:"아니요",
      reporter_name:"정우진", reporter_jumin:"8803151000000", reporter_qual:"부",
      reporter_addr:"경기도 군포시 당동 000-0, 101동 1001호", reporter_phone:"01012345678",
      reporter_email:"woojin@example.com"
    });
    if(kind==="unwed"){
      state.child_marital="혼인 외";
      state.child_headName="윤서연"; state.child_headRel="자녀(녀)";
      state.f_name=""; state.f_nameHan=""; state.f_bon=""; state.f_jumin=""; state.f_regBase=""; state.f_edu="";
      state.reporter_name="윤서연"; state.reporter_jumin="9007222000000"; state.reporter_qual="모";
      state.reporter_email="seoyeon@example.com";
    }
  }
};
